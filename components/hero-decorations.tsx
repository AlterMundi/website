...
// Paths are defined inner→outer so draw-path animates from center outward.

// Full spiral — reversed: center (26,21) → outer tip (89,0)
// viewBox "0 0 95 60", path length ≈ 206 → dasharray 210
const SPIRAL_PATH =
  "M 26 21 A 8 8 0 0 0 34 13 A 13 13 0 0 0 21 0 A 21 21 0 0 0 0 21 A 34 34 0 0 0 34 55 A 55 55 0 0 0 89 0"

// Partial spiral — reversed: center (26,21) → outer (0,21)
// viewBox "0 0 40 25", path length ≈ 66 → dasharray 68
const SMALL_PATH =
  "M 26 21 A 8 8 0 0 0 34 13 A 13 13 0 0 0 21 0 A 21 21 0 0 0 0 21"

// Mini spiral — reversed: inner tip (21,16) → outer (34,13)
// viewBox "0 0 38 25", path length ≈ 21 → dasharray 22
const MINI_PATH =
...
export function HeroDecorations() {
  return (
    <div className="absolute inset-0 pointer-events-none overflow-visible" aria-hidden="true">
      ...
      <svg
        className="absolute top-4 right-4 lg:right-8 w-[340px] lg:w-[500px] opacity-[0.07] animate-[float-hero_22s_ease-in-out_3.3s_infinite]"
      ...
      <svg
        className="absolute top-[15%] left-4 lg:left-8 w-[280px] lg:w-[380px] opacity-[0.05] animate-[float-hero_26s_ease-in-out_3.6s_infinite]"
        viewBox="0 0 95 60" fill="none" overflow="visible" style={{ height: "auto" }}
      >
      ...
      <svg
        className="absolute top-8 left-4 lg:top-12 lg:left-8 w-28 lg:w-44 animate-[float-hero_8s_ease-in-out_2.4s_infinite]"
        viewBox="0 0 95 60" fill="none" overflow="visible" style={{ height: "auto" }}
      >
      ...
      <svg
        className="absolute top-8 right-4 lg:top-12 lg:right-8 w-28 lg:w-44 animate-[float-hero_10s_ease-in-out_2.6s_infinite]"
        viewBox="0 0 95 60" fill="none" overflow="visible" style={{ height: "auto" }}
      >
        <g transform="scale(-1,1) translate(-95,0)">
          <path d={SPIRAL_PATH} stroke={primary} strokeWidth="1.5" opacity="0.4"
      ...
      <svg
        className="absolute top-[38%] left-2 lg:left-6 w-16 lg:w-24 animate-[float-hero_9s_ease-in-out_2s_infinite]"
      ...
      <svg
        className="absolute top-[55%] right-2 lg:right-6 w-16 lg:w-24 animate-[float-hero_7s_ease-in-out_2.1s_infinite]"
        viewBox="0 0 40 25" fill="none" overflow="visible" style={{ height: "auto" }}
      >
      ...
      <svg
        className="absolute bottom-16 left-4 lg:bottom-20 lg:left-8 w-20 lg:w-28 animate-[float-hero_6s_ease-in-out_2s_infinite]"
        viewBox="0 0 40 25" fill="none" overflow="visible" style={{ height: "auto" }}
      >
      ...
      <svg
        className="absolute bottom-16 right-4 lg:bottom-20 lg:right-8 w-20 lg:w-28 animate-[float-hero_6s_ease-in-out_2.1s_infinite]"
        viewBox="0 0 40 25" fill="none" overflow="visible" style={{ height: "auto" }}
      >
        <g transform="scale(-1,1) translate(-40,0)">
      ...
      <svg
        className="absolute top-[46%] left-[5%] w-10 animate-[float-hero_14s_ease-in-out_1.8s_infinite]"
      ...
      <svg
        className="absolute top-[33%] right-[5%] w-10 animate-[float-hero_12s_ease-in-out_2s_infinite]"
        viewBox="0 0 38 25" fill="none" overflow="visible" style={{ height: "auto" }}
      >
      ...
      {[
        ...
        { cls: "top-[18%] left-[38%]",  fill: lime,    r: 1.5, delay: 2.8 },
      ...
      {/* ── Extra large background spirals (very low opacity, slow float) ────── */}
      <svg
      ...
      {/* ── Extra corner spirals (bottom sides) ──────────────────────────────── */}
      <svg
        className="absolute bottom-24 left-[20%] lg:left-[25%] w-20 lg:w-32 animate-[float-hero_11s_ease-in-out_2.3s_infinite]"
        viewBox="0 0 40 25" fill="none" overflow="visible" style={{ height: "auto" }}
      >
        <path d={SMALL_PATH} stroke={forest} strokeWidth="1.5" opacity="0.4"
          strokeLinecap="round" style={draw(68, 1.2, 0.9)} />
        {SMALL_NODES.map((n, i) => (
          <circle key={i} cx={n.cx} cy={n.cy} r={n.r} fill={n.fill} fillOpacity="0.55"
            style={{ animation: `fade-in 350ms ease-out ${(0.9 + (i / 3) * 1.2).toFixed(2)}s both` }} />
        ))}
      </svg>

      <svg
        className="absolute bottom-24 right-[20%] lg:right-[25%] w-20 lg:w-32 animate-[float-hero_13s_ease-in-out_2.5s_infinite]"
        viewBox="0 0 40 25" fill="none" overflow="visible" style={{ height: "auto" }}
      >
        <g transform="scale(-1,1) translate(-40,0)">
      ...
      {/* ── Top-center mini spirals flanking the title ──────────────────────── */}
      <svg
        className="absolute top-[12%] left-[22%] lg:left-[28%] w-14 lg:w-20 animate-[float-hero_9s_ease-in-out_2.2s_infinite]"
        viewBox="0 0 38 25" fill="none" overflow="visible" style={{ height: "auto" }}
      >
        <path d={MINI_PATH} stroke={primary} strokeWidth="1.2" opacity="0.4"
          strokeLinecap="round" style={draw(22, 0.8, 1.0)} />
        <circle cx="34" cy="13" r="1.5" fill={primary} fillOpacity="0.5"
          style={{ animation: "fade-in 350ms ease-out 1.05s both" }} />
        <circle cx="26" cy="21" r="1.2" fill={lime} fillOpacity="0.5"
          style={{ animation: "fade-in 350ms ease-out 1.6s both" }} />
      </svg>

      <svg
        className="absolute top-[12%] right-[22%] lg:right-[28%] w-14 lg:w-20 animate-[float-hero_8s_ease-in-out_2.4s_infinite]"
        viewBox="0 0 38 25" fill="none" overflow="visible" style={{ height: "auto" }}
      >
        <g transform="scale(-1,1) translate(-38,0)">
          <path d={MINI_PATH} stroke={forest} strokeWidth="1.2" opacity="0.4"
            strokeLinecap="round" style={draw(22, 0.8, 1.1)} />
          <circle cx="34" cy="13" r="1.5" fill={forest}   fillOpacity="0.5"
            style={{ animation: "fade-in 350ms ease-out 1.15s both" }} />
          <circle cx="26" cy="21" r="1.2" fill={forest} fillOpacity="0.5"
            style={{ animation: "fade-in 350ms ease-out 1.7s both" }} />
        </g>
      </svg>
