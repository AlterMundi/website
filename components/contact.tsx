      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        <div className="space-y-5 sm:space-y-6">
            <div className="space-y-3 sm:space-y-4">
              <span className="text-xs font-mono uppercase tracking-wider text-primary crt-glow">{t.contact.eyebrow}</span>
              <h2 className="font-mono text-2xl sm:text-3xl lg:text-4xl font-bold leading-tight">{t.contact.heading}</h2>
